 ...
 *
 * Provides a CiviCRM Membership Product.
 *
...
/**
 * CiviCRM Membership Product class.
 *
 * @since 3.0
 */
class WC_Product_CiviCRM_Membership extends WC_Product_Simple {
	...
	public function set_backorders( $backorders ) {
		...
		if ( 'no' !== $backorders ) {
			$this->error(
				...
				__( 'CiviCRM Memberships cannot be backordered.', 'wpcv-woo-civi-integration' )
			);
		}
	}
	 ...
	 *
	 * We may wish to prevent this if the Customer already has a current Membership.
	 *
	 * @since 3.0
	 *
	 * @return boolean
