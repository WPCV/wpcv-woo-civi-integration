...
class WPCV_Woo_Civi_Admin_Migrate {
  ...
  public function admin_menu() {
    ...
    $this->migrate_page = add_submenu_page(
      ...
      'CiviCRM',
      // Page title.
      __('Integrate CiviCRM with WooCommerce', 'wpcv-woo-civi-integration'),
      // Menu title.
      __('WooCommerce', 'wpcv-woo-civi-integration'),
      // Required caps.
      'manage_options',
      // Slug name.
      $this->migrate_page_slug,
       // Callback.
      [$this, 'page_migrate'],
      10
    );
